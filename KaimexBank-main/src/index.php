...
$account1 = new BankAccount(400, $person);
pl('--------- [Start testing bank account #1, No overdraft] --------');
try {
    // show balance account
    $USaccount = new InternationalBankAccount(100, $person);
    echo "My balance on euros is " . $USaccount->getBalance();
    pl("<br>My balance on dolars are " . $USaccount->getConvertedBalance() . $USaccount->getConvertedCurrency());
    

    echo "Account 1 Balance:" . $account1->getBalance();
    // crear una cuenta con balance 400 y mostrar su balance
    $bankAccount1 = new BankAccount(400, $person);
...
$bankAccount2 = new BankAccount(100, $person);
